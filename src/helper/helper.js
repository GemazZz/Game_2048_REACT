...
export const plusFunc = (arr, num1, num2) => {
  if (arr[num1] === arr[num2]) {
    arr[num1] = arr[num1] * 2;
    arr[num2] = 0;
  }
};
export const swapFunc = (arr, num1, num2) => {
  if (arr[num1] !== 0 && arr[num2] === 0) {
    [arr[num1], arr[num2]] = [arr[num2], arr[num1]];
  }
};

export const sumFunc = (arr, num0, num1, num2, num3) => {
  plusFunc(arr, num3, num2);
  plusFunc(arr, num2, num1);
  plusFunc(arr, num1, num0);
};

export const rowFunc = (arr, num0, num1, num2, num3) => {
...
export const allTogetherFunc = (arr, num0, num1, num2, num3) => {
...
// console.log(arr);
// console.log(rightArrFunc(arr));
// console.log(leftArrFunc(arr));
// console.log(rightArrFunc(arr));
// console.log(leftArrFunc(arr));
